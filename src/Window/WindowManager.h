...
public:
	...
	void FollowWindow(HWND window) const noexcept;
	bool HasWindowMoved(HWND window, RECT& r_window_rect) const noexcept;
...
public:
	static volatile inline bool IsWindowValid = false;
